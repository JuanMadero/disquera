            ...
            <div class="card-body">
              <div class="container-fluid px-4">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <label for="" class="label">Tipo de documento<span class="text-danger">*</span></label>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre Artistico" aria-label="Last name">
                  </div>
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
                    <label for="">Email del Artista</label>
                    <input type="email" class="form-control" placeholder="Apellido" aria-label="Last name">
                  </div>
                  <div class="col-sm-4">
                    <label for="" class="label">Estado del Artista <span class="text-danger">*</span></label>
                    <select name="" id="" class="form-control">
