    ...
    <section>
      <div class="m-0 row justify-content-center">
        <div class="col-sm-10 p-5">
          <div class="card">
            <c:forEach var="generoLi" items="${generoList}">
            <div class="card-header">
              Editar Genero ${generoLi.getNombreGenero()}
            </div>
              ...
              <div class="container-fluid px-6">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre" value="${generoLi.getNombreGenero()}"aria-label="First name" name="nombreGenero">
                    <input hidden name="id" id="id" type="text" value="${generoLi.getIdGenero()}" >
                  </div>
                  <div class="col-sm-6">
                    <label for="" class="label">Estado del Genero<span class="text-danger">*</span></label>
                    <div>
                      <input type="checkbox" name="estadoGenero" id="estado" value="${generoLi.getEstadoGenero()}" checked class="form-check-input">
